...
const cardList = [
  ...
  {
    name: "Agent 6",
    description: "Agent 6 description 阿萨的表空间方便的吗使得按时间八十九海边酒店房卡氨甲环酸的金山词霸叫阿三的放假啊士大夫就喀什地方尽快SHD发哈士大夫v就卡还是v",
    icon: UserIcon,
  },
];
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center">
      <h1 className="model-title text-4xl font-bold text-primary py-10 whitespace-pre">张江高科·高科芯 德育大模型</h1>
      <UserPromptTextarea />
      <div className="grid grid-cols-3 gap-6 w-full mt-10 items-stretch px-4">
        {cardList.map((card) => (
